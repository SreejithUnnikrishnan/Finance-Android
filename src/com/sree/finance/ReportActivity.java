...
public class ReportActivity extends Activity {
	...
	private ImageButton quitReportButton;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (incomeTotal == 0.00 && expenseTotal == 0.00) {
			reportErrorTextView
					.setText("Add Income/Expense Details to See Report!!!");
		} else {
	...
	private OnClickListener quitReportButtonListener = new OnClickListener() {
